...
ineut=columnNames.index("neut") #index for column containing neutrons
...
isolist.append(['si27', 'si28', 'si29', 'si30', 'si31', 'si32', 'p29', 'p30', 'p31', 'p32', 'p33', 'p34'])
isolist.append(['s31', 's32', 's33', 's34', 's35', 's36', 's37', 'cl33', 'cl34', 'cl35', 'cl36', 'cl37', 'cl38'])
isolist.append(['ar36', 'ar37', 'ar38', 'ar39', 'ar40', 'ar41', 'k37', 'k38', 'k39', 'k40', 'k41', 'k42'])
isolist.append(['ca40', 'ca41', 'ca42', 'ca43', 'ca44', 'ca45', 'ca46', 'ca47', 'ca48', 'ca49', 'sc41', 'sc42', 'sc43', 'sc44', 'sc45', 'sc46', 'sc47', 'sc48', 'sc49', 'sc50'])
isolist.append(['ti44', 'ti45', 'ti46', 'ti47', 'ti48', 'ti49', 'ti50', 'ti51', 'v45', 'v46', 'v47', 'v48', 'v49', 'v50', 'v51', 'v52'])
isolist.append(['cr48', 'cr49', 'cr50', 'cr51', 'cr52', 'cr53', 'cr54', 'cr55', 'cr56', 'mn51', 'mn52', 'mn53', 'mn54', 'mn55', 'mn56', 'mn57'])
isolist.append(['fe52', 'fe53', 'fe54', 'fe55', 'fe56', 'fe57', 'fe58', 'fe59', 'fe60', 'fe61', 'co56', 'co57', 'co58', 'co59', 'co60', 'co61', 'co62'])
isolist.append(['ni56', 'ni57', 'ni58', 'ni59', 'ni60', 'ni61', 'ni62', 'ni63', 'ni64', 'ni65', 'cu57', 'cu58', 'cu59', 'cu60', 'cu61', 'cu62', 'cu63', 'cu64', 'cu65', 'cu66', 'zn60', 'zn61', 'zn62', 'zn63', 'zn64', 'zn65', 'zn66', 'zn67', 'zn68', 'zn69', 'ga62', 'ga63', 'ga64', 'ga65', 'ga66', 'ga67', 'ga68', 'ga69', 'ga70', 'ge64', 'ge65', 'ge66', 'ge67', 'ge68', 'ge69', 'ge70', 'ge71'])
...
print massnorm
"""
for i in range(len(isolist)): # here we add mass fractions of the isotope groupings together
    group = isolist[i]
    temp = []
    groupMassfracs = []
#    print group
...
outfile.write(str(zones)+'\t'+str(iso_num+2)+'\n') # this is the first line of the output file, with numbers of zones and isotopes

outfile.write('1.0d0 1.0d0 4.0d0 12.0d0 16.0d0 20.0d0 24.0d0 28.0d0 32.0d0 36.0d0 40.0d0 44.0d0 48.0d0 52.0d0 56.0d0 \n') # values of A for each isotope, starting with n, p, He-4, C-12...

outfile.write('0.0d0 1.0d0 2.0d0 6.0d0 8.0d0 10.0d0 12.0d0 14.0d0 16.0d0 18.0d0 20.0d0 22.0d0 24.0d0 26.0d0 28.0d0 \n') # values of Z for each isotope
...
#    print arr[i-1, columnNames.index("zone")]
    ...
    writeNewLine += "%15.6E" % (arr[i-1, iprot]) #abundance of h1 (no protons from photodisintegration)
