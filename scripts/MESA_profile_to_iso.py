...
def make_iso_file(input_profile, output=""):
    if output == "":
        pathout = input_profile.replace(".data", ".iso.dat")
    else:
        pathout = output
    ...
    with open(input_profile, "r") as modfile:
    ...
    arr = np.loadtxt(input_profile, skiprows=6)
    ...
    print("done isotopes file at ", pathout)


if __name__ == "__main__":
    input_profile = sys.argv[1]
    output = sys.argv[2]
    make_iso_file(input_profile, output)
